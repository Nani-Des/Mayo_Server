...
public class PatientEventConsumer {
    ...
    public void consumePatientEvent(
        ...
        try {
            log.debug("Received patient event: key={}, topic={}, partition={}, offset={}",
                     key, topic, partition, offset);

            // Parse the patient event JSON
            ...
            log.info("Successfully processed patient event for user: {}", userId);

        } catch (Exception e) {
            log.error("Failed to process patient event: {}", message, e);
